...
export function encodeToURL(payload: object | string | number | boolean | null | Array<object | string | number | boolean | null>): void {
...
export function decodeFromURL(): object | string | number | boolean | null | Array<object | string | number | boolean | null> | null {
